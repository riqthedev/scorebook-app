...
const initialPlayers: Players = [
    { id: 1, status: "Active", playerName: "K.Durant", points: 29, rebounds: 4, fouls: 0 },
    { id: 2, status: "Active", playerName: "S,Curry", points: 40, rebounds: 2, fouls: 1 },
    { id: 3, status: "Active", playerName: "D.Green", points: 5, rebounds: 10, fouls: 4 },
    { id: 4, status: "Active", playerName: "J.Poole", points: 15, rebounds: 4, fouls: 1 },
    { id: 5, status: "Active", playerName: "K.Thompson", points: 10, rebounds: 4, fouls: 2 },
    { id: 6, status: "Active", playerName: "K.Looney", points: 2, rebounds: 18, fouls: 2 }
]
